...
namespace Sciencetopia.Controllers.KnowledgeNetwork
{
    [ApiController]
    [Route("api/nodes")]
    public class L10nController : ControllerBase
    {
        private readonly IL10nService _l10n;
        public L10nController(IL10nService l10n) { _l10n = l10n; }
        ...
        {
            var value = await _l10n.GetLocalizedAsync(id, field, lang);
            return Ok(value);
        }
        ...
        {
            var items = await _l10n.ListAsync(id, field);
            return Ok(items);
        }
        ...
        public async Task<ActionResult<Guid>> Upsert(Guid id, [FromBody] UpsertRequest req)
        {
            ...
            var result = await _l10n.UpsertAsync(id, req.fieldKey, req.lang, req.value, req.isLongText, req.primary, req.sortOrder);
            return Ok(result);
        }
        ...
        {
            await _l10n.RemoveAsync(id, itemId);
            return NoContent();
        }
    }
}
