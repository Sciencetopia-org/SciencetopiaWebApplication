...
namespace SciencetopiaWebApplication.Migrations
{
    ...
    [Migration("20251230154607_updateGroupCohortPlanDb")]
    partial class updateGroupCohortPlanDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sciencetopia.Models.UserGroupEntity", b =>
                {
                    ...
                    b.ToTable("GroupMembers", "StudyGroups");
                });
            ...
            modelBuilder.Entity("Sciencetopia.Models.UserStudyPlanEnrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserId", "StudyPlanStableId");

                    b.ToTable("UserStudyPlanEnrollments", "StudyPlans");
                });
            ...
            modelBuilder.Entity("Sciencetopia.Models.CohortEntity", b =>
                {
                    ...
                    b.HasOne("Sciencetopia.Models.GroupEntity", null)
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sciencetopia.Models.UserGroupEntity", b =>
                {
                    b.HasOne("Sciencetopia.Models.StudyGroupEntity", "StudyGroup")
                        .WithMany("UserRoles")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
