...
namespace SciencetopiaWebApplication.Migrations
{
    ...
    [Migration("20260514154431_SyncStudyGroupDiscoverySnapshot")]
    partial class SyncStudyGroupDiscoverySnapshot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sciencetopia.Models.CohortEntity", b =>
                {
                    ...
                    b.HasIndex("StudyGroupStudyPlanId", "Status");
            ...
            modelBuilder.Entity("Sciencetopia.Models.GroupPlanEnrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("GroupId", "StudyPlanStableId")
                        .IsUnique()
                        .HasFilter("[Status] = 'Active'");

                    b.ToTable("GroupPlanEnrollments", "StudyPlans", t =>
                        {
                            t.HasCheckConstraint("CK_GroupPlanEnrollments_Status", "Status IN ('Active','Archived')");

                            t.HasCheckConstraint("CK_GroupPlanEnrollments_VersionPolicy", "VersionPolicy IN ('Current','Pinned')");
                        });
                });
            ...
            modelBuilder.Entity("Sciencetopia.Models.StudyGroupEmbedding", b =>
                {
                    ...
                    b.ToTable("StudyGroupEmbeddings", "StudyGroups");
                });
            ...
            modelBuilder.Entity("Sciencetopia.Models.StudyGroupRecommendationFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("GroupId", "Action", "CreatedAt");

                    b.ToTable("StudyGroupRecommendationFeedback", "StudyGroups");
                });

            modelBuilder.Entity("Sciencetopia.Models.StudyGroupRecommendationRequestLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("StudyGroupRecommendationRequestLogs", "StudyGroups");
                });
            ...
            modelBuilder.Entity("Sciencetopia.Models.StudyGroupEmbedding", b =>
                {
                    b.HasOne("Sciencetopia.Models.StudyGroupEntity", null)
                        .WithOne()
                        .HasForeignKey("Sciencetopia.Models.StudyGroupEmbedding", "GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
