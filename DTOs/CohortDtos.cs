...
public record CohortViewDto(Guid Id, Guid StudyPlanId, string? Title, string? Visibility, DateTime? StartAt, DateTime? EndAt, string? CreatedBy, DateTime CreatedAt);
